/*
  # Fix categories system with events constraint update

  1. Clean up existing triggers and policies
  2. Update events constraint to include "Autre"
  3. Clean up duplicate categories
  4. Create simplified protection system
  5. Only "Autre" is protected as fallback
*/
...
-- Supprimer l'ancienne contrainte de catégorie pour events
ALTER TABLE events DROP CONSTRAINT IF EXISTS events_category_check;

-- Créer une nouvelle contrainte qui inclut "Autre"
