/*
  # Système de catégories avec protection et fallback

  1. Modifications
    - Ajout de la colonne `is_protected` pour protéger certaines catégories
    - Création de la catégorie "Autre" protégée comme fallback
    - Politiques RLS pour gérer les permissions
    - Triggers pour empêcher suppression/modification de "Autre"
    - Fonction de fallback automatique

  2. Sécurité
    - Politiques RLS séparées pour chaque opération
    - Protection de la catégorie "Autre" contre suppression/modification
    - Fallback automatique lors de suppression de catégories
*/
