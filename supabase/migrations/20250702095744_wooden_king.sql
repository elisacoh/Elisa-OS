/*
  # Système de catégories avec protection et nettoyage des doublons

  1. Nettoyage des doublons
    - Suppression temporaire des triggers pour permettre le nettoyage
    - Conversion ou création d'une catégorie "Autre" protégée unique
    - Suppression des doublons avec redirection des références

  2. Protection renforcée
    - Politiques RLS strictes
    - Triggers de protection contre modification/suppression
...
-- Désactiver temporairement TOUS les triggers pour permettre le nettoyage
...
CREATE FUNCTION ensure_fallback_category_exists()
RETURNS TRIGGER AS $$
DECLARE
...
-- Créer les triggers de protection (en utilisant CREATE au lieu de CREATE OR REPLACE)
